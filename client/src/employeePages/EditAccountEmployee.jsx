...
const EditAccountEmployee = () => {
    ...
    useEffect(()=>{
        const fetchAccount = async ()=>{
            try{
                const res = await axios.get(`${process.env.REACT_APP_API}/employees/ownacc/${encodeURIComponent(email)}`,
                    {
                        headers: {
    ...
    const handleClick = async e =>{ //do async for api requests
        ...
        try{
            const res = await axios.put(`${process.env.REACT_APP_API}/employees/editacc`, {
