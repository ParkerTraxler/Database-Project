...
const EditHistoryReport = () => {
    ...
    const fetchReport = async () => {
        ...
        try {
            ...
            const res = await axios.get(`http://mfa-backend-chh3dph8gjbtd2h5.canadacentral-01.azurewebsites.net/reports/change-history/${encodeURIComponent(email)}/${timeRange.startDate}/${timeRange.endDate}/${actionType}/${effectedTable}`, {
                headers: {
