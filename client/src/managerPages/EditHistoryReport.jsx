...
const EditHistoryReport = () => {
    ...
    const fetchReport = async () => {
        ...
        try {
            ...
            const res = await axios.get(`${process.env.REACT_APP_API}/reports/change-history/${encodeURIComponent(email)}/${timeRange.startDate}/${timeRange.endDate}/${actionType}/${effectedTable}`, {
                headers: {
