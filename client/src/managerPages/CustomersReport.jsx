...
const CustomersReport = () => {
    ...
    const fetchCustomers = async () => {
        ...
        try {
            ...
            const res = await axios.get(`http://mfa-backend-chh3dph8gjbtd2h5.canadacentral-01.azurewebsites.net/reports/customer-report/${encodeURIComponent(email)}/${timeRange}/${promoFilter}/${memberFilter}`, {
                headers: {
