...
const EditTicket = () => {
    ...
    useEffect(()=>{
        const fetchTicket = async ()=>{
            try{
                const res = await axios.get(`https://mfa-backend-chh3dph8gjbtd2h5.canadacentral-01.azurewebsites.net/items/tickets/${ticketID}`,
                    {
                        headers: {
    ...
    const handleClick = async e =>{ //do async for api requests
        ...
        try{
            ...
            const res = await axios.put(`https://mfa-backend-chh3dph8gjbtd2h5.canadacentral-01.azurewebsites.net/items/tickets/${ticketID}`, {
                itemid: ticketID,
