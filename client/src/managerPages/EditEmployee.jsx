...
const EditEmployee = () => {
    ...
    useEffect(()=>{
        const fetchAllManagers = async ()=>{
            try{
                const res = await axios.get(`https://mfa-backend-chh3dph8gjbtd2h5.canadacentral-01.azurewebsites.net/managers`)
                console.log(res.data)
    ...
    useEffect(()=>{
        const fetchEmployee = async ()=>{
            try{
                const res = await axios.get(`https://mfa-backend-chh3dph8gjbtd2h5.canadacentral-01.azurewebsites.net/employees/${email}`,
                    {
                        headers: {
