    ...
    return(
        ...
        <div className="managerView">
            ...
            <div className="manageraccount-details-Box">
                ...
                <div className="manageraccount-details-detail"><strong>Position:</strong> {details.EPosition || "Not assigned"}</div>
                ...
                <div className="manageraccount-details-detail"><strong>Email:</strong> {details.Email}</div>
            </div>
            </div>
        </div>    
        </div>
